...
WebUI.waitForElementVisible(findTestObject('Page_User/td_user_collection_modified'), 180)
...
List<WebElement> originalTableElements = WebUI.findWebElements(findTestObject('Page_User/td_user_collection_modified'), 30)
