...
WebUI.waitForElementVisible(findTestObject('Page_User/td_user_collection_email'), 180)

// Ascending Order
WebUI.click(findTestObject('Page_User/header_user_email'))
...
List<WebElement> getTableValues() {
    List<WebElement> tableElements = WebUI.findWebElements(findTestObject('Page_User/td_user_collection_email'), 30)
