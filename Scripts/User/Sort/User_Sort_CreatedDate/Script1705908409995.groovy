...
WebUI.waitForElementVisible(findTestObject('Page_User/td_user_collection_created'), 180)
...
List<WebElement> originalTableElements = WebUI.findWebElements(findTestObject('Page_User/td_user_collection_created'), 30)
