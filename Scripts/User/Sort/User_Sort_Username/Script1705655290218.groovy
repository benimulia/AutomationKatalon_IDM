...
WebUI.waitForElementVisible(findTestObject('Page_User/td_user_collection_username'), 180)

// Ascending Order
WebUI.click(findTestObject('Page_User/header_user_username'))
...
List<WebElement> getTableValues() {
    List<WebElement> tableElements = WebUI.findWebElements(findTestObject('Page_User/td_user_collection_username'), 30)
