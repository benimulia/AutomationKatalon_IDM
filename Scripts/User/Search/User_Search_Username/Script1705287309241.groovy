...
WebUI.setText(findTestObject('Page_User/input_header-search-username'), input)

WebUI.delay(15, FailureHandling.STOP_ON_FAILURE)

def actual_text = WebUI.getText(findTestObject('Object Repository/Page_User/td_user_username'))
