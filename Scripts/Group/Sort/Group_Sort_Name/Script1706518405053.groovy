...
WebUI.waitForElementVisible(findTestObject('Page_Group/td_group_collection_name'), 180)

// Ascending Order
WebUI.click(findTestObject('Page_Group/header_group_name'))
...
List<WebElement> getTableValues() {
    List<WebElement> tableElements = WebUI.findWebElements(findTestObject('Page_Group/td_group_collection_name'), 30)
